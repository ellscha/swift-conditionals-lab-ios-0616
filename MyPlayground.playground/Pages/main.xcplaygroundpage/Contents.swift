...
*/
// write your code here
func takeTenIfCan(myBankAccount: Float, yourBankAccount: Float) {
    if yourBankAccount > 10.0 {
        var yourNewBalance = yourBankAccount - 10.0
        var myNewBalance = myBankAccount + 10.0
    }
    
}


takeTenIfCan(10000.00, yourBankAccount: 12.0)
